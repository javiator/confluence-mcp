...
def test_entity_extraction_from_search():
    ...
    from chat_app.entities import extract_entities_from_tool_result
...
def test_entity_context_injection_supervisor():
    ...
    from chat_app.entities import format_entity_context
...
def test_coreference_resolution():
    ...
    from chat_app.entities import resolve_coreference
...
def test_reasoning_trace_populated():
    ...
    from chat_app.graph import AgentState
